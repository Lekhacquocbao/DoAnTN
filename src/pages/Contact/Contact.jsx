      ...
      <div className={cx('breadcrumb')}>
        ...
        <div className={cx('info-section')}>
          <div className={cx('info-item')}>
            <div className={cx('icon')}><i className="fas fa-phone-alt"></i></div>
          ...
          <div className={cx('info-item')}>
            <div className={cx('icon')}><i className="fas fa-map-marker-alt"></i></div>
            <div className={cx('info')}>
          ...
          <div className={cx('info-item')}>
            <div className={cx('icon')}><i className="fas fa-envelope"></i></div>
            <div className={cx('info')}>
              <h3>Bộ phận hỗ trợ</h3>
              <p>petcung@gmail.com</p>
            </div>
          </div>
        </div>
