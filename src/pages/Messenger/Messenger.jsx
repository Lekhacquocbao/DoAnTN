...
//   const [chatUserName, setChatUserName] = useState('Message');
...
//       });
//       // console.log("post haha", response.data);
...
//         headers: { Authorization: `Bearer ${GetToken()}` },
//       });
//       console.log('post hạ hạ', response.data);
...
//                   isSender
//                     ? chat.reciever_firstname + ' ' + chat.reciever_lastname
//                     : chat.sender_firstname + ' ' + chat.sender_lastname,
//                 )
//               }
//             >
...
//               <div className={cx('messageTime')}> {msg.createdAt}</div>
//             </div>
//           ))}
//         </div>
...
//             }}
//           />
//           {/* <button onClick={(newMessage, chatUserId)=>handleSendMessage(newMessage,chatUserId)}>Send</button> */}
//         </div>
//       </div>
//     </div>
//   );
