...
//   }
//   console.log("data service nef", data);
//   return (
...
//       {/* <div className={cx('name-order')}>{}</div> */}
    ...
    <div className={cx('order')}>
      ...
      >
        <animated.div style={modalAnimationDetail}>
          ...
          <div className={cx('detail')}>
            {/* <Image className={cx('detail-image')} src={data.Account.inforUser.avatar} alt="avatar"></Image> */}
            <Image className={cx('detail-image')} src={appointmentDetail.Service ? appointmentDetail.Service.image : ''} alt="avatar"></Image>
            <div className={cx('detail-item')}>
              <label className={cx('detail-label')}>Name:</label>
              <div className={cx('detail-value')}>
                {data.Account.inforUser.firstname + ' ' + data.Account.inforUser.lastname}
            ...
            <div className={cx('detail-item')}>
              ...
              <div className={cx('detail-value')}>{appointmentDetail.Service ? appointmentDetail.Service.description : ''}</div>
            </div>
            ...
            {/* <div className={cx('detail-item')}>
              <label className={cx('detail-label')}>Price service:</label>
              <div className={cx('detail-value')}>{appointmentDetail.Service ? appointmentDetail.Service.price : ''}</div>
            </div> */}
